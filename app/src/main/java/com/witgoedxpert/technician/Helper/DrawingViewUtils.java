...
public class DrawingViewUtils extends View {
	...
	public DrawingViewUtils(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}
	...
	{
		drawsignature(mDrawCanvas);
		drawPaths(mDrawCanvas);
		return mCanvasBitmap;
	}

	// You can use this method if you want to undo that you draw
	...
	// you can call this method if to want to redo
